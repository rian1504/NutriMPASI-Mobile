...
class AppIcons {
  ...
  static IconData get arrowRight => PhosphorIcons.caretRight(PhosphorIconsStyle.bold);
  static IconData get arrowDown => PhosphorIcons.caretDown(PhosphorIconsStyle.bold);
  ...
  static IconData get notificationFill => PhosphorIcons.bellRinging(PhosphorIconsStyle.fill);
  // static IconData get loveFill => PhosphorIcons.heart(PhosphorIconsStyle.fill);
  static IconData get commentFill => PhosphorIcons.chat(PhosphorIconsStyle.fill);
  static IconData get editFill => PhosphorIcons.pencilSimple(PhosphorIconsStyle.fill);
  static IconData get baby => PhosphorIcons.babyCarriage(PhosphorIconsStyle.fill);
  ...
  static IconData get deleteFill => PhosphorIcons.trash(PhosphorIconsStyle.fill);
