...
class ReportButton extends StatelessWidget {
  ...
  const ReportButton({super.key, required this.content});
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      onPressed: () {
        final rootContext = context; // Simpan context dari luar (sebelum dialog)
        showDialog(
          context: context,
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        showDialog(
                          context: rootContext, // gunakan context yang valid
                          barrierDismissible: false,
                          useRootNavigator: true, // <-- ini penting
                          builder:
                              (context) => MessageDialog(
                                imagePath: "assets/images/card/lapor_konten.png",
                                message: "Berhasil melaporkan $content ini",
                              ),
                        );

                        // Tunggu 2 detik lalu tutup dialog dan halaman sebelumnya
                        ...
                        Navigator.of(
                          rootContext,
                          rootNavigator: true,
                        ).pop(); // Tutup dialog popup berhasil
                      },
                      child: Text('Kirim'),
                    ),
                  ],
...
//       child: Icon(AppIcons.report, size: 20, color: AppColors.greyDark),
//       onTap: () {
//         final rootContext = context; // Simpan context dari luar (sebelum dialog)
//         showDialog(
//           context: context,
